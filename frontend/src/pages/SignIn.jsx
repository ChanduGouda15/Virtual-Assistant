...
function SignIn() {
  ...
  return (
    <div className='w-full h-[100vh] bg-cover flex justify-center items-center' style={{backgroundImage: `url(${bg})`}}>
        ...
        justify-center gap-[20px] rounded-[50px] px-[10px]'onSubmit={handleSignIn}>
        ...
        <p className='text-white text-[18px] cursor-pointer'onClick={()=>navigate("/signup")}>
            Want to create a new Account ? <span className='cursor-pointer text-blue-400'>Sign Up</span>
        </p>
        </form>
    </div>
  )
